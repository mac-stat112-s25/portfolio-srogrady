...
# there are many starbucks and they are most common in the United States and Europe
...
#the data points are represented through contour lines the closer together they are the higher the density. 
# What changed in our code?!
#instead of a geom_point it is now a density_2d 
ggplot(cma_boundaries) + 
  geom_sf() + 
  geom_density_2d(
    data = starbucks_cma,
...
#used with the geom_map function and the limits
